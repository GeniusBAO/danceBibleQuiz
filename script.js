...
const goodResponseSound = new Audio("./AudioNimage/sound2a.wav");
const badResponseSound = new Audio("./AudioNimage/badsound.wav");

// Define background music
const backgroundMusic = new Audio("./AudioNimage/bckg5.wav");

// Define achievement sounds and images
const achievementSounds = [
  new Audio("./AudioNimage/Thank.wav"),
  new Audio("./AudioNimage/clapping.wav"),
  new Audio("./AudioNimage/sound3a.wav"),
  new Audio("./AudioNimage/sound4a.wav"),
];
